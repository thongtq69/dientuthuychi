export function SectionHeading({ eyebrow, title, description, actionLabel = 'Xem thêm' }) {
  return (
    <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
      ...
      <a href="#" className="inline-flex items-center gap-2 text-sm font-semibold text-slate-900 transition hover:text-sky-600">
        {actionLabel}
